...
export const SET_OPTIONS_PANEL_CLOSED_NO_SELECTION =
  'SET_OPTIONS_PANEL_CLOSED_NO_SELECTION';
export const SET_OPTIONS_PANEL_CLOSED_ONBLUR =
  'SET_OPTIONS_PANEL_CLOSED_ONBLUR';
export const SET_NEXT_SELECTED_INDEX = 'SET_NEXT_SELECTED_INDEX';
export const SET_NEXT_SELECTED_INDEX_ALPHA_NUMERIC =
